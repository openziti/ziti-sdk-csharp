...
#else
            verifyFieldCheck(native_structs.f01, "ziti_auth_query_mfa", 16, 28);
            // verifyFieldCheck(native_structs.f02, "ziti_id_cfg", 56, 12);
            // verifyFieldCheck(native_structs.f03, "ziti_config", 80, 16);
            // verifyFieldCheck(native_structs.f04, "api_path", 108, 4);
            // verifyFieldCheck(native_structs.f05, "ziti_api_versions", 124, 4);
            // verifyFieldCheck(native_structs.f06, "ziti_version", 140, 16);
            // verifyFieldCheck(native_structs.f07, "ziti_identity", 168, 12);
            // verifyFieldCheck(native_structs.f08, "ziti_process", 192, 4);
            // verifyFieldCheck(native_structs.f10, "ziti_posture_query_set", 252, 16);
            // verifyFieldCheck(native_structs.f11, "ziti_session_type", 280, 4);
            // verifyFieldCheck(native_structs.f12, "ziti_service", 296, 36);
            // verifyFieldCheck(native_structs.f13, "ziti_address_host", 344, 260);
            // verifyFieldCheck(native_structs.f14, "ziti_address_cidr", 616, 4);
            // verifyFieldCheck(native_structs.f15, "ziti_client_cfg_v1", 888, 264);
            // verifyFieldCheck(native_structs.f16, "ziti_intercept_cfg_v1", 1164, 20);
            // verifyFieldCheck(native_structs.f17, "ziti_server_cfg_v1", 1196, 12);
            // verifyFieldCheck(native_structs.f18, "ziti_listen_options", 1224, 40);
            // verifyFieldCheck(native_structs.f19, "ziti_host_cfg_v1", 1276, 44);
            // verifyFieldCheck(native_structs.f20, "ziti_host_cfg_v2", 1332, 4);
            // verifyFieldCheck(native_structs.f21, "ziti_mfa_enrollment", 1348, 12);
            // verifyFieldCheck(native_structs.f22, "ziti_port_range", 1372, 8);
            // verifyFieldCheck(native_structs.f23, "ziti_options", 1392, 64);
            // verifyFieldCheck(native_structs.f24, "ziti_context_event", 1468, 20);
            // verifyFieldCheck(native_structs.f25, "ziti_router_event", 1500, 20);
            // verifyFieldCheck(native_structs.f26, "ziti_service_event", 1532, 20);
            // verifyFieldCheck(native_structs.f27, "ziti_mfa_auth_event", 1564, 20);
            // verifyFieldCheck(native_structs.f28, "ziti_api_event", 1596, 20);
#endif
